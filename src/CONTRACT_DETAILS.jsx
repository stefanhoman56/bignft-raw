...
export const NFT_CONTRACT_ADDRESS_PHASE = {
  1: isTestnet
    ? "0x9FA324b0496A3FD27f85A54f3dFBb87D48642f07" // test contract w/ lower hardcap
    : "0x1f4e4570Cb635D350Fb606814c18c5157286Ec08",
  2: isTestnet
    ? "0x576c1e3de0b76b5e2b5a34cf0795e33259eb07e6" // test contract w/ lower hardcap
    : "0x9539A41B3FC9f6fbeB0A9cB7196DFb40fd7202AC",
  3: isTestnet
    ? "0x70C717c2085FbD48B09902D8e26077968b5D9196" // test contract w/ lower hardcap
    : "0xCafE12e0D06743176389d8B7c50647721D54fC67",
};
...
export const LAUNCH_DATE_UTC = `1/17/2023`; // mm/dd/yyyy
